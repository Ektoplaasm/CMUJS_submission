        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php echo form_open('volumes/create')?>
                  <div class="mb-3">
                    <label class="form-label">Volume Name
                    </label>
                    <input type="text" class="form-control" placeholder="Volume Name" name="volume_name">
                  </div>
                  <div class="mb-1">
                  ...
                  <div class="mb-3 row pt-3">
                    <div class="col-sm-4" style="display:flex;">
                      ...
                      &nbsp;
                      <div class="form-check py-2">
                        <input type="checkbox" class="form-check-input" id="customCheck2" name="archive">
                        <label class="form-check-label" for="customCheck2">Archive</label>
                      </div>
                    </div>
